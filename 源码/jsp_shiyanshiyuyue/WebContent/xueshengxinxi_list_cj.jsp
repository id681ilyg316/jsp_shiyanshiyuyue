...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
  <tr>
	...
	<td width="90" align="center" bgcolor="#CCFFFF">�ɼ�����</td>
  </tr>
  <% 
...
//txixixngdy
    ...
    String url = "xueshengxinxi_list_cj.jsp?1=1"; 
...
//youzuiping2
  ...
  <tr>
	...
	<td width="90" align="center"><a href="chengjixinxi_add.jsp?id=<%=map.get("id")%>">�ɼ�����</a></td>
  </tr>
  	<%
  }
   %>
