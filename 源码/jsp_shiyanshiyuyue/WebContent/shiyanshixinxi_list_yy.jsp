...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
  <tr>
    ...
    <td width="100" align="center" bgcolor="CCFFFF">����</td>
  </tr>
  <% 
...
//txixixngdy
    ...
    String url = "shiyanshixinxi_list_yy.jsp?1=1"; 
...
//youzuiping2
  ...
  <tr>
    ...
    <td width="100" align="center"><a href="yuyuejilu_add.jsp?id=<%=map.get("id")%>">��ҪԤԼ</a>  <a href="shiyanshixinxi_list_yy.jsp?scid=<%=map.get("id") %>" onClick="return confirm('���Ҫɾ����')"></a> <!--qiatnalijne--> </td>
  </tr>
  	<%
  }
   %>
