...
<div class="amanagemenu_div">
  ...
  <div class="dtree">
	...
	<script type="text/javascript">
		...
		d.add(2,0,'authority','','实验室管理 ');
		d.add(3,0,'authority','','学生信息管理 ');
		d.add(4,0,'authority','','教师信息管理 ');
		d.add(5,0,'authority','','系统管理 ',"","","","","","","","open");
		
		d.add(12,1,'authority','','修改密码 ',"","","mod.jsp");
		d.add(13,1,'authority','','管理员用户 ',"","","yhzhgl.jsp");
//		d.add(14,1,'authority','','注册用户管理 ',"","","yonghuzhuce_list.jsp");
		
		d.add(12,2,'authority','','实验室添加 ',"","","shiyanshixinxi_add.jsp");
		d.add(13,2,'authority','','实验室管理 ',"","","shiyanshixinxi_list.jsp");
		d.add(14,2,'authority','','预约记录管理 ',"","","yuyuejilu_list.jsp");
				
		d.add(12,3,'authority','','班级信息添加 ',"","","banji_add.jsp");
		d.add(13,3,'authority','','班级信息管理 ',"","","banji_list.jsp");
		d.add(14,3,'authority','','学生信息添加 ',"","","xueshengxinxi_add.jsp");
		d.add(15,3,'authority','','学生信息管理 ',"","","xueshengxinxi_list.jsp");
		
		d.add(12,4,'authority','','教师信息添加 ',"","","jiaoshixinxi_add.jsp");
		d.add(13,4,'authority','','教师信息管理 ',"","","jiaoshixinxi_list.jsp");
