...
//		d.add(3,0,'authority','','学生成绩管理 ');
//		d.add(4,0,'authority','','考勤管理 ');
//		d.add(5,0,'authority','','学校评论查询 ');
//		d.add(6,0,'authority','','系统管理 ',"","","","","","","","open");
		
		d.add(12,1,'authority','','个人资料管理 ',"","","jiaoshixinxi_updt2.jsp");
		...
		d.add(12,3,'authority','','学生成绩添加 ',"","","xueshengxinxi_list_cj.jsp");
		d.add(13,3,'authority','','学生成绩管理 ',"","","chengjixinxi_list.jsp");
		
		d.add(12,4,'authority','','考勤添加 ',"","","kechengxinxi_list2_kq.jsp");
		d.add(13,4,'authority','','考勤管理 ',"","","kaoqinjilu_list.jsp");
		
		d.add(12,5,'authority','','学校评论查询 ',"","","news.jsp?lb=学校评论");
