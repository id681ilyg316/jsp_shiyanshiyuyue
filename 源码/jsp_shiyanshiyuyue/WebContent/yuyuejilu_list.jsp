...
<!--hxsglxiangdxongjxs-->
  ...
  <form name="form1" id="form1" action="">
   ...
   <input type="submit" name="Submit" value="����" style='border:solid 1px #000000; color:#666666' /> <input type="button" name="Submit2" value="����EXCEL" style='border:solid 1px #000000; color:#666666' onClick="javascript:location.href='yuyuejilu_listxls.jsp';" />
</form>
...
//youzuiping2
  ...
  <tr>
    ...
    <td width="60" align="center"><a href="yuyuejilu_updt.jsp?id=<%=map.get("id")%>">�޸�</a>  <a href="yuyuejilu_list.jsp?scid=<%=map.get("id") %>" onclick="return confirm('���Ҫɾ����')">ɾ��</a> <!--qiatnalijne--> </td>
  </tr>
  	<%
  }
   %>
