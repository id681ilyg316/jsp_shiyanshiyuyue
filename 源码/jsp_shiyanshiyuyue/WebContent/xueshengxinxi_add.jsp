 ...
 <form  action="xueshengxinxi_add.jsp?f=f&id=<%=id%>"  name="form1"  onsubmit="return checkform();">
  ...
  <br><br>
   <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">
		...
		<tr><td>�༶��</td><td><%=Info.getselect("banji","banji","banji")%></td></tr>
		...
		<tr><td  width="200">��ͥסַ��</td><td><input name='jiatingzhuzhi' type='text' id='jiatingzhuzhi' value='' onblur='' size='50' style='border:solid 1px #000000; color:#666666' /></td></tr>
