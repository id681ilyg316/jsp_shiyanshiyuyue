...
{
	out.print("<script>alert('�Բ���,�����ȵ�½!');parent.location=parent.location;</script>");
}
%>
...
new CommDAO().insert(request,response,"pinglun",ext,true,true,""); 
   ...
   function check()
{
	if(document.form1.pinglunneirong.value==""){alert("��������������");document.form1.pinglunneirong.focus();return false;}
}
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#333333" style="border-collapse:collapse" class="newsline">
    ...
    <tr>
      <td>&nbsp;</td>
      <td><input type="submit" name="Submit5" value="�ύ" onclick="return check();" />
